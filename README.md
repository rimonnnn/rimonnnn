...
<h3 align="center">
Flutter Developer | Mobile App Developer | Dart & Firebase Enthusiast
</h3>

<p align="center">
I build modern cross-platform mobile applications using Flutter with clean UI, API integration, local storage, state management, and maintainable project structure.
</p>
...
- Flutter Developer focused on building clean, responsive, and scalable mobile apps.
- Experienced in converting UI designs into real Flutter applications.
...
A modern Flutter news application that displays latest headlines, supports search, categories, article details, localization, and API integration.

**Tech Used:** Flutter, Dart, Dio, REST API, Bloc/Cubit, GoRouter, Easy Localization, Cached Network Image, ScreenUtil

<p>
  <a href="https://github.com/rimonnnn/news_app" target="_blank">
...
A Flutter meals application with clean UI, categories, meal details, favorites, local storage, and organized navigation.

**Tech Used:** Flutter, Dart, SQLite, SharedPreferences, GoRouter, Responsive UI

<p>
  <a href="https://github.com/rimonnnn/meals-app-" target="_blank">
    <img src="https://img.shields.io/badge/View%20Repository-181717?style=for-the-badge&logo=github&logoColor=white" />
  </a>
</p>
...
A modern finance UI application with onboarding screens, authentication flow, responsive design, reusable widgets, and clean structure.

**Tech Used:** Flutter, Dart, Provider, Authentication Flow, Responsive UI, Clean Project Structure

<p>
  <a href="https://github.com/rimonnnn/financeApp" target="_blank">
    <img src="https://img.shields.io/badge/View%20Repository-181717?style=for-the-badge&logo=github&logoColor=white" />
  </a>
</p>
